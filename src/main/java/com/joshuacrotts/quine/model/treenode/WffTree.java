...
public class WffTree implements Copyable, TexPrintable {
    ...
    public boolean stringEquals(Object _obj) {
        ...
        if ((this.isIdentity() && o.isIdentity())
                && (QuineUtils.sbCompareTo(w1, w2.reverse()) == 0
                || QuineUtils.sbCompareTo(w1.reverse(), w2.reverse()) == 0
                || QuineUtils.sbCompareTo(w1.reverse(), w2) == 0)) {
            return true;
        } else {
